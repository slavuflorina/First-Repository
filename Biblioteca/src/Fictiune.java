...
public class Fictiune extends JFrame implements ActionListener {
	private JButton b1;
	private JButton b2;
	private JButton b3;
	private JButton b4;
		...
		try{
			Connection conn=DriverManager.getConnection("jdbc:mysql://localhost/biblioteca","root","fllorina");
			 String query="select * from carti";
				...
				while(rs.next()){
					if(rs.getString("categorie").equals("Fictiune"))
	...
	public Fictiune(){
		setTitle( "Carti disponibile in categoria Fictiune" ); 
		setSize( 1200, 600 ); 
