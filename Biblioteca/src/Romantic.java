...
public class Romantic extends JFrame implements ActionListener {
	private JButton b1;
	private JButton b2;
	private JButton b3;
	private JButton b4;
		...
		try{
			Connection conn=DriverManager.getConnection("jdbc:mysql://localhost/biblioteca","root","flower");
			 String query="select * from carti";
				...
				while(rs.next()){
					if(rs.getString("categorie").equals("Romantic"))
	...
	public Romantic(){
		setTitle( "Carti disponibile in categoria Romantic" ); 
		setSize( 1200, 600 ); 
