...
<nav class="navbar navbar-expand-lg navbar-light bg-light " >
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent" >
    <ul class="navbar-nav mr-auto" >
	  ...
	  <li class="nav-item active">
        <a class="navbar-brand text-primary" href="<?php echo site_url('users/get_all_users')?>">Utilizatori</a>
      </li>
	  <li class="nav-item active">
...
<h1 align="center" style="margin-top: 30px; color: #0000FF; #">Welcome, Admin <?php echo $this->session->userdata('email');?>!</h1>